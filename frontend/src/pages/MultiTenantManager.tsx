...
export default function MultiTenantManager() {
    ...
    const dadosTenants = [
        { nome: "FIEPA", risco: "45%", incidentes_critico: "1.234", incidentes_alto: "2.500", ativos: "50", volume: "150 GB", status: "Médio" },
        { nome: "FORMOSA", risco: "78%", incidentes_critico: "3.892", incidentes_alto: "2.500", ativos: "26", volume: "230 GB", status: "Crítico" },
        { nome: "DORA", risco: "18%", incidentes_critico: "421", incidentes_alto: "2.500", ativos: "12", volume: "80 GB", status: "Baixo" },
        { nome: "QOLINTY", risco: "62%", incidentes_critico: "2.112", incidentes_alto: "2.500", ativos: "33", volume: "190 GB", status: "Alto" },
        { nome: "ENTERPRISE", risco: "90%", incidentes_critico: "4.501", incidentes_alto: "2.500", ativos: "80", volume: "300 GB", status: "Crítico" },
        { nome: "SOC PRIME", risco: "35%", incidentes_critico: "950", incidentes_alto: "2.500", ativos: "20", volume: "110 GB", status: "Médio" },
    ];
            ...
            <div className="space-y-6">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="mt-4">
                                        <span className="px-3 py-1 text-xs rounded-full bg-purple-500/20 text-purple-400">
                                            {tenant.risco} Risco {tenant.status}
                                        </span>
                                    </div>
                ...
                <div className="cards rounded-2xl overflow-hidden border border-[#1D1929]">
                    ...
                    <div className="grid grid-cols-12 px-5 py-5 bg-[#0A0617] text-xs text-gray-300">
                        ...
                        <div className="col-span-2 border-[#1D1929] border-r-2">
                        ...
                        <div className="col-span-1 border-[#1D1929] border-r-2">
                            {/* @ts-ignore */}
                    ...
                    <div className="divide-y divide-[#ffffff12]">
                        ...
                        {tenantsSelecionados.length === 0 ? (
                            ...
                            tenantsFiltrados.map((tenant) => (
                                <div
                                    key={tenant.nome}
                                    className="grid grid-cols-12 px-5 py-4 items-center hover:bg-[#ffffff07] transition-colors"
                                >
                                    <div className="col-span-2 text-center text-sm text-gray-400 flex items-center justify-center gap-2">
                                        {/* @ts-ignore */}
                                        <LuBuilding2 /> {tenant.nome}
                                    </div>

                                    <div className="col-span-2 text-center font-medium text-purple-400">
                                        {tenant.risco}
                                    </div>
                                    ...
                                    <div className="col-span-2 text-center">
                                        <span className="text-[11px] px-2 py-0.5 rounded-md bg-purple-500/20 text-purple-400">
                                            {tenant.status}
                                        </span>
                                    </div>
                                </div>
