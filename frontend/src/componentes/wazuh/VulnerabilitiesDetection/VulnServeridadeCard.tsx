...
import { useTenant } from "../../../context/TenantContext"; // 👈 adiciona tenant global
...
const VulnSeveridadeCard = forwardRef<VulnSeveridadeCardRef, Props>(
  ({ onAtualizar }, ref) => {
    ...
    const carregar = async () => {
      ...
      setLoading(true);
      try {
        // 🔹 service usa o tenant internamente (como os outros)
      ...
      <section className="cards p-6 rounded-2xl shadow-lg">
        <div className="flex flex-wrap justify-between items-start mb-6">
          ...
          <div className="flex items-end gap-3 flex-wrap">
            <button
              onClick={onAtualizar || carregar} // 👈 fallback: recarrega
